...
<div id="header">
		<div class="row-1">
			<div class="fleft"><a href="#"><img src="../<?= DIR_IMAGES?>logo.png" alt="" /></a></div>
				       ...
				       <!-- MENU -->
                       <div class="menu">
							<?php  	require_once("../".DIR_INCLUDES.DIR_MENU."menu.php");  ?>
                        </div>
            			<!-- MENU -->
            
				<div class="wellcome">Welcome, <?php echo selectName($user_login) ;?> ||  <a href="<?=HTTP_SERVER_TRUE.SSO?>/logout.php">Logout</a> </div>
