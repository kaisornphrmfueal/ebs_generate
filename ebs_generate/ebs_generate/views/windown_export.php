...
<form id="form1" name="form1" method="post" action="">
    ...
    <tr>
     <th height="30" colspan="17">Order imported confirmation     </th>
     </tr>
    <tr>
...
<a href="report_to_excel.php?gids=<?=$gviewg?>&uid=<?=$user_login?>" ><strong>Export to Excel</strong></a> ||
<a href="report_to_csv.php?gids=<?=$gviewg?>&uid=<?=$user_login?>" target="_blank" ><strong>Export To CSV</strong></a>
