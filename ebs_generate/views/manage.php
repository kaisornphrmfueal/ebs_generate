...
<div class="rightPane">  
  ...
  <table width="97%" height="172" border="1" bordercolor="#CC9966"class="table01">
    ...
    <tr>
      ...
      <td align="center" height="30px" <?php if($np>1){ $nps = $np+1;echo "rowspan='".$nps."'";}?> ><?=$i?></td>
      <td align="center" <?php if($np>1){ $nps = $np+1;echo "rowspan='".$nps."'";}?>>
       <a href="#" onClick="javascript:openWins('windows.php?win=edit&idm=<?=$rs['id_master'];?>', '_blank', 1050, 650, 1, 1, 0, 0, 0);return false;"  >
