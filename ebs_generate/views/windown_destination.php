...
if(!empty($_POST['btnhid']) AND $_POST['btnhid']=="Save"){
	...
	$gms_del_code = mysqli_real_escape_string($con, $_POST['gms_del_code']);
	$sname = mysqli_real_escape_string($con, $_POST['sname']);
	$plist = mysqli_real_escape_string($con, $_POST['plist']);
	$cern = mysqli_real_escape_string($con, $_POST['cern']);
	$remark = mysqli_real_escape_string($con, $_POST['remark']);

	 $sqli="INSERT INTO ".DB_DATABASE.".ebs_customer_destination SET 
	id_master='".$_POST['hidm']."', plant='$plant', gms_delivery_place_code='$gms_del_code',
...
log_histlog_hist($user_login,'Add','ebs_customer_destination',$maxdest);
	...
	customer_code='$code', ship_name='$sname',gms_delivery_place_code='$gms_del_code',
			...
			<div align="center">   
				...
				if(!empty($_GET['ida']) AND $_GET['ida']=="addst"){
					...
					if(!empty($_GET['eid']) AND $_GET['eid']=="pedit"){
						$iddest=$_GET['ids'];
						$sqle=" SELECT a.id_destination,a.id_master,a.plant,a.remark,a.gms_delivery_place_code,
							...
							<table width="766" border="1" class="table01" align="center">
								...
								<tr>
									...
									<td width="600"><div class="tmagin_right">
										<input type="text" name="code" id="code"onkeypress="return isNumberKey(this); "  value="<?php if(!empty($rse['customer_code'])){echo $rse['customer_code'];}?>"/>  
										<span class="txt-red-b">*Exp. 2</span></div></td>
									</tr>
								<tr>
								  <td height="25"><div class="tmagin_left">GMS Delivery Place Code : </div></td>
								  <td><div class="tmagin_right" >
								    <input type="text" name="gms_del_code" id="gms_del_code" onkeypress="return isNumberKey(this); " value="<?php if(!empty($rse['gms_delivery_place_code'])){echo $rse['gms_delivery_place_code'];}?>"/>
							      <span class="txt-red-b">*Exp. 21</span></div></td>
							  </tr>
									...
									<?php
									$sql="SELECT a.id_destination,a.id_master,a.plant,a.remark,a.gms_delivery_place_code,
									a.customer_code,a.ship_name,a.price_list,a.currency,b.company_name
									FROM ".DB_DATABASE.".ebs_customer_master b
									LEFT JOIN ".DB_DATABASE.".ebs_customer_destination a ON  b.id_master = a.id_master
									...
									if($num<>0){
										...
										<table width="98%" border="1" class="table01" align="center">
											...
											<tr>
												...
												<th><span class="tmagin_left">GMS Delivery Place Code</span></th>
												<th width="72"><span class="tmagin_left">Plant</span></th>
											...
											while($rs=mysqli_fetch_array($qr)){
												...
												<tr   <?php $v =0; $v = $v + 1; echo  icolor($v); ?>  onmouseover="className=&quot;over&quot;"  onMouseOut="className=&quot;&quot;" height="25px" align="center">
													...
													<td width="86"><?php echo $rs['gms_delivery_place_code'];?></td>
													<td><?php echo $rs['plant'];?></td>
													<td width="75"><?php echo $rs['currency'];?></td>
													<td width="177"><?php echo $rs['price_list'];?></td>
